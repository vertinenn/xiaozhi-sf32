...
#define CODE_START_ADDR                                    (FLASH_TABLE_START_ADDR)
#define CODE_SIZE                                          (FLASH_TABLE_SIZE)
